...
Nordic marketplace for leftover tradesperson capacity sold **at a discount** — hours (min 3), days, or one week — at a **visible price**. Not bidding.
...
1. **Landing** — Norwegian default hero (*Rabattert ledig tid hos håndverkere*) and CTAs: *Se ledig tid* / *Selg ledig tid*. Badge: *Rabatterte ledige slots*. Switcher **nb / sv / en** changes landing strings only.
